from psd2.modeling.meta_arch import FCOS
                    ...
                    with torch.no_grad():
                        for img_idx, image_size in enumerate(image_list.image_sizes):
                            scores_per_image = [
                                ...
                                torch.sqrt(
                                    x[img_idx].sigmoid_() * y[img_idx].sigmoid_()
                                )
...
@META_ARCH_REGISTRY.register()
class TiFcos_Baseline_JointDc(TiFcos_Baseline):
...
@META_ARCH_REGISTRY.register()
class TiFcos_C4Side(TiFcos_Baseline):
    @configurable
...
@META_ARCH_REGISTRY.register()
class TiFcos_C4Side_JointDc(TiFcos_Baseline_JointDc,TiFcos_C4Side):
    @configurable
    def __init__(self, bn_neck, side_init, **kwargs) -> None:
        super(TiFcos_C4Side,self).__init__(**kwargs)
...
@META_ARCH_REGISTRY.register()
class TiFcos_C4SideTrip_JointDc(TiFcos_C4Side_JointDc):
    @configurable
...
@META_ARCH_REGISTRY.register()
class TiFcos_C4SideTrip1(TiFcos_C4Side):
    @configurable
    def __init__(self, *args, **kwargs) -> None:
        super().__init__(*args, **kwargs)
        self.triplet_loss = TripletLoss(0.3, "mean")
...
@META_ARCH_REGISTRY.register()
class TiFcos_C4SideTrip1Ms1(TiFcos_C4SideTrip1):
    @configurable
    def __init__(self, *args, **kwargs) -> None:
        super().__init__(*args, **kwargs)
        self.side_res5 = nn.Sequential(
...
@META_ARCH_REGISTRY.register()
class TiFcos_C4SideTrip1Ms2(TiFcos_C4SideTrip1Ms1):
    @configurable
    def __init__(self, *args, **kwargs) -> None:
        super().__init__(*args, **kwargs)
        self.output3 = Conv2d(
...
@META_ARCH_REGISTRY.register()
class TiFcos_C4SideTrip1Ms3(TiFcos_C4SideTrip1Ms1):
    @configurable
    def __init__(self, *args, **kwargs) -> None:
        super().__init__(*args, **kwargs)
        self.output3 = Conv2d(
...
@META_ARCH_REGISTRY.register()
class TiFcos_C4SideTrip1Ms4(TiFcos_C4SideTrip1Ms1):
    @configurable
    def __init__(self, *args, **kwargs) -> None:
        super().__init__(*args, **kwargs)
        self.output3 = Conv2d(
...
@META_ARCH_REGISTRY.register()
class TiFcos_C4SideD3(TiFcos_C4Side):
    @configurable
    def __init__(self, bn_neck, side_init, **kwargs) -> None:
        super(TiFcos_C4Side, self).__init__(**kwargs)
    ...
    def load_state_dict(self, *args, **kws):
        output = super(TiFcos_C4Side, self).load_state_dict(*args, **kws)
        model_resume = True
        for param_k in output.missing_keys:
            if "side_res" in param_k:
                model_resume = False
    ...
    def get_reid_person_features(self, reid_backbone_features, person_boxes):
        ...
        return roi_feats
@META_ARCH_REGISTRY.register()
class TiFcos_R34C4Side(TiFcos_C4Side):
    @configurable
    def __init__(self, bn_neck, side_init, **kwargs) -> None:
        super(TiFcos_C4Side, self).__init__(**kwargs)
...
@META_ARCH_REGISTRY.register()
class TiFcos_R34C4SideTrip1(TiFcos_R34C4Side):
    @configurable
    def __init__(self, *args, **kwargs) -> None:
        super().__init__(*args, **kwargs)
        self.triplet_loss = TripletLoss(0.3, "mean")
...
@META_ARCH_REGISTRY.register()
class TiFcos_R34C4Ladder3(TiFcos_Baseline):
    @configurable
    def __init__(self, bn_neck, side_init, **kwargs) -> None:
        super().__init__(**kwargs)
...
@META_ARCH_REGISTRY.register()
class TiFcos_Os4Ladder3(TiFcos_Baseline):
    @configurable
    def __init__(self, bn_neck, side_init, **kwargs) -> None:
        super().__init__(**kwargs)
...
@META_ARCH_REGISTRY.register()
class TiFcos_C4Res5Joint(TiFcos_Baseline):
    @configurable
    def __init__(self, bn_neck, side_init, **kwargs) -> None:
        super().__init__(**kwargs)
...
@META_ARCH_REGISTRY.register()
class TiFcos_Coupled(TiFcos_Baseline):
    @configurable
