...
class Trainer(DefaultTrainer):
    ...
    def build_optimizer(cls, cfg, model):
        ...
        param_dicts = [
            {"params": head},
            {"params": backbone_no_decay, "weight_decay": 0.0, "lr": lr},
    ...
    def build_lr_scheduler(cls, cfg, optimizer):
        ...
        from psd2.solver.lr_scheduler import LRMultiplier, WarmupParamScheduler

        lr_min = cfg.MODEL.SEARCH.SOLVER.LR_MIN
        lr_max = cfg.SOLVER.BASE_LR
        sched = CosineParamScheduler(start_value=1, end_value=lr_min / lr_max)
