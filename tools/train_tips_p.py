...
from fdps.checkpoint import DetectionCheckpointer
from fdps.config import get_cfg
from fdps.data import MetadataCatalog
from fdps.engine import (
    DefaultTrainer,
...
from fdps.modeling import GeneralizedRCNNWithTTA
...
class Trainer(DefaultTrainer):
    ...
    def build_test_loader(cls, cfg, dataset_name):
        from fdps.data.catalog import MapperCatalog
        from fdps.data.build import get_detection_dataset_dicts, trivial_batch_collator
        from fdps.data.common import DatasetFromList, MapDataset
        from fdps.data.samplers import InferenceSampler
    ...
    def build_optimizer(cls, cfg, model):
        from fdps.solver.build import maybe_add_gradient_clipping
        import re
        logger = logging.getLogger("psd2.trainer")
        frozen_params = []
        learn_param_keys = []
