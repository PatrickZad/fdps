...
class ResNet(Backbone):
    ...
    def __init__(self, stem, stages, num_classes=None, out_features=None, freeze_at=0,checkpoint_at=6):
        """
        Args:
...
def build_resnet_backbone(cfg, input_shape):
    ...
    checkpoint_at       = cfg.MODEL.RESNETS.CHECKPOINT_AT
    # fmt: on
    ...
    return ResNet(stem, stages, out_features=out_features, freeze_at=freeze_at,checkpoint_at=checkpoint_at)

@BACKBONE_REGISTRY.register()
def build_resnet_backbone_lite(cfg, input_shape):
    """
    Create a ResNet instance from config.
...
@BACKBONE_REGISTRY.register()
def build_resnet_backbone_minor(cfg, input_shape):
    """
    Create a ResNet instance from config.
