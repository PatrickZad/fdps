...
import copy
import time
from psd2.modeling.meta_arch.person_search import TiRetina_Baseline,TiRetina_Baseline_JointDc
...
class TiRetina_2StreamOnCrops(TiRetina_Baseline):
    @configurable
...
@META_ARCH_REGISTRY.register()
class TiRetina_JointDc_2StreamOnCrops(TiRetina_2StreamOnCrops,TiRetina_Baseline_JointDc):
    def forward(self, input_list):
        return TiRetina_Baseline_JointDc.forward(self,input_list)
    def forward_det(self, image_list, features, gt_instances):
        return TiRetina_Baseline_JointDc.forward_det(self, image_list, features, gt_instances)
    def get_ps_pos_samples(self,gts):
        return TiRetina_Baseline_JointDc.get_ps_pos_samples(self,gts)
...
@META_ARCH_REGISTRY.register()
class TiRetina_C4Side2StreamOnCrops(TiRetina_2StreamOnCrops):
    @configurable
...
@META_ARCH_REGISTRY.register()
class TiRetina_C4Side2StreamOnCrops_JointDc(TiRetina_JointDc_2StreamOnCrops,TiRetina_C4Side2StreamOnCrops):
    @configurable
    def __init__(self,bn_neck, side_init,*args, **kwargs) -> None:
        TiRetina_JointDc_2StreamOnCrops.__init__(self,*args,**kwargs)
        self.side_init = side_init
        self.alpha_res3 = nn.Parameter(torch.tensor(0.0))
        self.alpha_res4 = nn.Parameter(torch.tensor(0.0))
        # side reid network
...
@META_ARCH_REGISTRY.register()
class TiRetina_C4Side2StreamOnCropsOimProtoCon(TiRetina_C4Side2StreamOnCrops):
    @configurable
...
@META_ARCH_REGISTRY.register()
class TiRetina_C4Side2StreamOnCropsOimProtoConRe(TiRetina_C4Side2StreamOnCropsOimProtoCon):
    @configurable
    def __init__(self, *args, **kwargs) -> None:
        super().__init__(*args,**kwargs)
...
@META_ARCH_REGISTRY.register()
class TiRetina_C4Side2StreamOnCropsOimProtoConReFlip(TiRetina_C4Side2StreamOnCropsOimProtoConRe):
    def get_crops(self,image_list,boxes):
        tgt_size=(256,128)
        crops=[]
        for bi,boxesi in enumerate(boxes):
...
@META_ARCH_REGISTRY.register()
class TiRetina_C4Side2StreamOnCropsOimProtoConReFlip_JointDc(TiRetina_C4Side2StreamOnCrops_JointDc):
    @configurable
    def __init__(self, *args, **kwargs) -> None:
        super().__init__(*args,**kwargs)
        self.re=RandomErasingAfterNorm(self.pixel_mean[:,0,0],self.pixel_std[:,0,0])
...
@META_ARCH_REGISTRY.register()
class TiRetina_C4Side2StreamOnCropsOimProtoConReFlipTrip(TiRetina_C4Side2StreamOnCropsOimProtoConReFlip):
    @configurable
    def __init__(self, *args, **kwargs) -> None:
        super().__init__(*args,**kwargs)
...
@META_ARCH_REGISTRY.register()
class TiRetina_C4Side2StreamOnCropsOimProtoConReFlipTrip_JointDc(TiRetina_C4Side2StreamOnCropsOimProtoConReFlip_JointDc):
    @configurable
    def __init__(self, *args, **kwargs) -> None:
        super().__init__(*args,**kwargs)
        self.triplet_loss = TripletLoss(0.3, "mean")
...
# TODO
@META_ARCH_REGISTRY.register()
class TiRetina_NextC4Side2StreamOnCropsOimProtoConReFlip(TiRetina_C4Side2StreamOnCropsOimProtoConReFlip):
    @configurable
    def __init__(
        self,
    ...
    def load_state_dict(self, *args, **kws):
        ...
        output = super(TiRetina_Baseline,self).load_state_dict(*args, **kws)
        return output
    @classmethod
    def from_config(cls, cfg):
        raise NotImplementedError
...
@META_ARCH_REGISTRY.register()
class TiRetina_C4DSide2StreamOnCropsOimProtoConReFlip(TiRetina_C4Side2StreamOnCropsOimProtoConReFlip):
    @configurable
