...
def build_evaluator(cfg, dataset_name, output_folder=None):
    ...
    if evaluator_type is "det":
        ...
        if "CUHK-SYSU" in dataset_name:
            ...
            evaluator_list.append(
                QueryEvaluator(dataset_name, distributed=True, output_dir=output_folder)
            )
...
class Trainer(DefaultTrainer):
    ...
    def __init__(self, cfg):
        super().__init__(cfg, model_find_unused_parameters=False)
    ...
    def build_optimizer(cls, cfg, model):
        ...
        optim_name = cfg.MODEL.SEARCH.SOLVER.OPTIM
        ...
        param_dicts = [
            ...
            },
            {
                ...
                "lr": cfg.MODEL.SEARCH.SOLVER.BACKBONE_LR,
            },
            {
                "params": [
                    p
                    for n, p in model.named_parameters()
                    if _match_name_keywords(n, lr_linear_proj_names) and p.requires_grad
                ],
                "lr": cfg.SOLVER.BASE_LR
                * cfg.MODEL.SEARCH.SOLVER.LINEAR_PROJ_LR_FACTOR,
            },
        ]
