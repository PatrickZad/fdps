...
from fdps.config.config import configurable

from fdps.layers import ShapeSpec, batched_nms
from fdps.structures import (
    Boxes,
    ImageList,
    Instances,
...
class FCOSHead(RetinaNetHead):
    ...
    def forward(self, features, return_embed=False):
        ...
        if return_embed:
            return logits, bbox_reg, ctrness, return_embed
